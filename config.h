...
static const float fullscreen_bg[]         = {1.0f, 0.1f, 0.1f, 1.0f}; /* You can also use glsl colors */
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT|WLR_MODIFIER_CTRL, XKB_KEY_X,          quit,           {0} },
    ...
    { 0, XKB_KEY_Print                ,spawn, SHCMD("~/.local/bin/screenshot")},
